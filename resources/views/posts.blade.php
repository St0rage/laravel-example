...
@section('container')
    ...
    @if ($posts->count())    
        <div class="card mb-3">
            ...
            @else   
            <img src="https://via.placeholder.com/1200x400" class="card-img-top" alt="{{ $posts[0]->category->name }}">
            @endif
                ...
                @foreach ( $posts->skip(1) as $post )
                    <div class="col-md-4 mb-3">
                        <div class="card">
                            ...
                            @else   
                                <img src="https://via.placeholder.com/500x400" class="card-img-top" alt="{{ $posts[0]->category->name }}">
                            @endif
                            <div class="card-body">
